...
theseOnes <- td@values
theseOnes <- theseOnes[ theseOnes$accepted, ]
...
baseWiki <- "-----\n#### Synapse Certified Users with verified profiles may request access to the mPower data set for research to benefit human health. Below are all of the data access requests that have been approved for the mPower data set.\n-----\n"
fullWiki <- baseWiki
